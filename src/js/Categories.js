...
import { Card, cardBtnListener } from './Card.js'
let activeCategory = ''
...
const categoryListener = (cart) => {
  ...
  const listener = (event) => {
    ...
    const url = `https://www.googleapis.com/books/v1/volumes?q="subject:${event.target.innerText}"&key=${apiKey.key}&printType=books&startIndex=0&maxResults=6&langRestrict=en`
...
export { Categories, categoryListener, getActiveCategory };